...
exports.initialize = function (theServer) {
	...
	everyone.now.Sapply = function (functionName, args, roomId) {
		...
		if (functionName instanceof String && args === undefined && roomId === undefined) { //did not provide args or roomId
			roomId = "everyone"
			args = []
		}  else if (functionName instanceof String && args instanceof Array && roomId === undefined) { //provided args
			roomId = "everyone"
		} else if (functionName instanceof Function && args instanceof String) { //provided roomId
			roomId = args
			args = []
		} //provided errything
		var room = nowjs.getGroup(roomId);
